...
type Options struct {
	...
	NoFilterWildcard   bool   // NoFilterWildcard will disable wildcard filtering
	...
	WildcardOutputFile string // WildcardOutputFile specifies output directory for wildcard
...
func ParseOptions() *Options {
	...
	flag.BoolVar(&options.NoFilterWildcard, "no-filter-wildcard", false, "Disable wildcard check on all found subdomains")
